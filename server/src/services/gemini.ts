...
【議論の厳格なルール】
1. **短く鋭く**: 各発言は必ず【120文字以内で、短文で完結】させてください。長広舌はテンポを損なうため厳禁です（ユーザーから長すぎると指摘されています）。
2. **2巡・計10ターンの構成**: 必ず【5人全員が2回ずつ発言】するように、合計10個の \`<debate_turn>\` を順番に出力してください。
   - 【第1巡】(ターン1〜5): 各自の専門視点（分析、時間、お金、感情など）から、対象サブスクの未来価値データに対する初期評価や厳しい宣告を順番に行う。（必ず5人全員が1回ずつ発言）
   - 【第2巡】(ターン6〜10): 1巡目の発言を踏まえて意見をぶつけ合い、より深い視点（サンクコスト、代替手段、人生の浪費など）から互いに反論・同調し、最終的な結論へと昇華させる。（さらに5人全員が1回ずつ発言）
   ※ 同じキャラクターが連続して発言したり、発言しないキャラクターがいてはいけません。必ず5つのキャラクターが均等に2回ずつ登場するように調整してください。
